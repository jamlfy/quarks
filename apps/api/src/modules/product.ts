...
import { getAll, getOne, create, update, checkout, injectProductService } from '@quarks/product-controller';
...
productRouter.all('/:id/:system', requireAuth, injectTransactionService, checkout);
